...
import com.tcoproject.server.services.priceData.PriceDataService
...
class PriceDataFetchAndPersistQueueReceiver {
    ...
    void receiveRequest(PriceDataFetchAndPersistRequest request) {
        ...
        log.debug "[*] <========== Received [${request}] from queue ${PriceDataFetchAndPersistQueueSender.QUEUE_PRICE_DATA_FETCH_PERSIST}"
